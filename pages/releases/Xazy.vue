  ...
  <div class="ne-tvoy-drug-xazy w-100">
    <div class="row mb-5 fill d-flex">
      <div class="col-12 col-md-6 align-self-center">
        <NuxtImg src="/static/xazy.webp" style="max-width: 80%; height: auto;" format="webp" :quality="85" />
      </div>
      <div class="col-12 col-md-6 align-self-center">
        <div class="mt-5">
          <h5 class="text-white release-name">Ne Tvoy Drug</h5>
          <h5 class="text-white">
            <span class="text-nowrap">Xazy</span>
          </h5>
          <div>
            <div
              v-for="link in links"
    ...
    <div class="row">
      <div class="col-md-12 mb-5">
        <NuxtImg
          src="/static/ne_tvoy_drug_face.webp"
          alt="Ne Tvoy Drug"
    ...
    <div class="row mb-5">
      <div class="col-md-6 offset-md-2">
        <iframe style="border: 0; width: 100%; height: 120px;" src="https://bandcamp.com/EmbeddedPlayer/album=3610587038/size=large/bgcol=333333/linkcol=0f91ff/tracklist=false/artwork=small/transparent=true/" seamless>
        </iframe>
      </div>
    </div>
    ...
    <div class="row mb-5">
      <div class="col-md-4 mt-5">
        <NuxtImg
          src="/static/xazy_cassette_1.webp"
          alt="xazy_cassette_1"
      ...
      <div class="col-md-4 mt-5">
        <NuxtImg
          src="/static/xazy_cassette_2.webp"
          alt="xazy_cassette_2"
          style="display: block; width: 90%; height: auto; margin: 0 auto;"
         format="webp" :quality="85" loading="lazy" />
      </div>
      <div class="col-md-4 mt-5">
        <NuxtImg
          src="/static/xazy_cassette_3.webp"
          alt="xazy_cassette_3"
          style="display: block; width: 90%; height: auto; margin: 0 auto;"
         format="webp" :quality="85" loading="lazy" />
      </div>
      ...
      links: [
        {
          name: 'Bandcamp',
          icon: 'bandcamp',
          link: 'https://mestnost.bandcamp.com/album/xazy',
        },
        {
          name: 'Spotify',
          icon: 'spotify',
